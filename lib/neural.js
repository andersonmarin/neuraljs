...
module.exports = function () {
  ...
  * @param  {Array} inputQuantidade quantidade de neuronios iniciais
  ...
  */
  function treinar(dados, inputQuantidade, profundidade, quantidade) {
    var time = new Date();
    var neuronios = gerarNeuronios(profundidade || 0, quantidade || 0);
    var inputNeuros = [];
    for (var i = 0; i < inputQuantidade; i++) {
      inputNeuros.push(new Neuronio());
    }
